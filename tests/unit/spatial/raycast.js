(function() {
  ...
  function diagonalDistance(diffX, diffY) {
    var dX = diffX * cellsize + 1, dY = diffY * cellsize + 1;
  ...
  test("Check multiple hits", function(_) {
    var origin, direction, expectedResults = {}, e, f, results;
    ...
    */
    ...
    for (var i = 0; i < 5; ++i)
      for (var j = 0; j < 5; ++j)
        if (i !== j) temps.push(createEntity(i, j));
  ...
  test("Check diagonal hits", function(_) {
    var origin, direction, expectedResults = {}, e, results;
  ...
  test("Check first hit", function(_) {
    var origin, direction, expectedResults = {}, e, f, g, h, results;
  ...
  test("Check intersection with hitbox outside entity (CBR)", function(_) {
    var origin, direction, expectedResults = {}, e, f, g, results;
  ...
  test("Check more complex scenarios", function(_) {
    var origin, direction, expectedResults = {}, e, f, dX, dY, results;
  ...
  test("Check a complex scenario constructed in playground", function(_) {
    var origin, direction, magnitude, expectedResults = {}, results;
