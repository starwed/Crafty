...
(function(global$1) {
    ...
    createClass(Assert, [
      ...
      },
      {
        ...
        value: function push(result, actual, expected, message, negative) {
          ...
          var currentAssert = this instanceof Assert
            ? this
        ...
        value: function throws(block, expected, message) {
          ...
          if (actual) {
            ...
            if (!expected) {
              ...
              expectedType === "function" && actual instanceof expected
            ) {
              result = true;
              ...
              expectedType === "function" && expected.call({}, actual) === true
            ) {
              expected = null;
              result = true;
            }
    ...
    createClass(SuiteReport, [
      ...
      },
      {
        ...
        value: function getTestCounts() {
          var counts = arguments.length > 0 && arguments[0] !== undefined
            ? arguments[0]
  ...
  function begin() {
    ...
    if (!config.started) {
      ...
      if (
        config.modules[0].name === "" && config.modules[0].tests.length === 0
      ) {
    ...
    QUnit.log(function(details) {
      ...
      if (!details.result && hasOwn.call(details, "expected")) {
        ...
        if (actual !== expected) {
          ...
          if (
            !/^(true|false)$/.test(actual) && !/^(true|false)$/.test(expected)
          ) {
              ...
              if (countDelete !== 0 && countInsert !== 0) {
                ...
                if (commonlength !== 0) {
                  if (
                    ...
                    diffs[pointer - countDelete - countInsert - 1][
                      1
